...
<Page>
    ...
    <section id="contest">
        ...
        <p>
            On every day but the last of a season, <em>four</em> "Market Day" tournaments will be held. These tournaments award no prizes but can give players a sense of how well their contract performs against others.
        </p>
        <p>
        ...
        <p>
            To participate in tournaments, players must make at least one code submission while that season is open (before the Grand Faire). Only the most recent submission will be used. <em>Submissions from a prior season will not automatically roll over into the next.</em>
        </p>
        <p>
